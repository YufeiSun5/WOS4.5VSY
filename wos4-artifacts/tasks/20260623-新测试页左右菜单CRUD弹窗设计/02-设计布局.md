...
```text
PalimpsestClient
├─ LeftPageSlot percentage 18
│  └─ PalimpsestMenu page
└─ RightPageSlot percentage 82
...
- 两个页面对象在同一客户端视口内同时可见。
- 左侧页面槽位约占 18%，右侧页面槽位约占 82%，逻辑宽度和为 100。
- 左侧菜单点击能影响右侧内容页面。
