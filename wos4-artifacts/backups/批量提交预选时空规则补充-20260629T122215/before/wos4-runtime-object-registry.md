...
- 当前版本/运行状态：历史记录显示实例行 `v3`，提交进度 `100% / 提交成功`
...
| `pal_mentor` | 业务事对象 | 计划 | historical/live-count | `1729382256910290478` | `e5f53ccc-c021-4e40-9ed5-5c58a7a11e97` | 待复核 | 待复核 | `PalimpsestL1_0626R2` | 计划页 live 查询显示 `共 5 条`；ID/GUID 来自历史证据 |
| `pal_menu_node` | 业务事对象 | 计划 | historical/live-count | `1729382256910290479` | `e953278d-ceab-475d-99a6-e45428d8fae9` | 待复核 | 待复核 | `PalimpsestL1_0626R2` | 同上 |
...
补充：2026-06-29 向学智账号核实中，`计划 -> 业务事` 查询显示 `共 5 条`，虚拟表格当前只渲染前三条；`历史 -> 业务事` 查询显示并渲染 3 条。对象 ID 查询框未立即过滤虚拟表格，未作为后两条计划对象 copy GUID 的证据。
