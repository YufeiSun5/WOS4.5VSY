...
- Create/Update/Delete/Submit real record shape was verified from the local manual and compiled in `PalimpsestBackend_CUSTOMFUNC_CUSTOMFUNC` on 2026-06-27. Use business-event record type `4106`, name identifier `2`, and record condition mode `51` for record-id updates/deletes.
- `CreateAssessmentRecord` uses `Create(param,input,output)` with `input.fieldValues=[{objectName:"pal_assessment_record",dataFields:[...],dataValues:[...]}]`.
