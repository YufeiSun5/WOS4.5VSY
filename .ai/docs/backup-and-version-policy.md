...
- `wos4-artifacts/config/browser-harness-chrome-profile/`、Cookie、History、Login Data、Web Data、Local State 和 LOCK 文件必须被 `.gitignore` 忽略。
- 若发现浏览器 profile 或真实 ini 已被 Git 跟踪，必须停止提交并先移出索引。
